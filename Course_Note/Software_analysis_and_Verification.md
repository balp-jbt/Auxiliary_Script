...
<img src="./data/2.jpg" alt="1" style="zoom:50%;" />

<img src="./data/3.jpg" alt="1" style="zoom:50%;" />
...
霍尔证明系统是相对完备的，暨：对于部分简单语言，如本课程使用的语言，其是完备的，可推导出语言中所有有效的霍尔三元组；但语言复杂时等情况下，其完备性可能不成立
